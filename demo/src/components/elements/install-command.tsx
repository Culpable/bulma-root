  ...
  return (
    ...
    >
      ...
      <button
        ...
        commandfor="snippet"
        type="button"
        className="group relative flex size-9 cursor-pointer items-center justify-center rounded-full after:absolute after:-inset-1 hover:bg-mist-950/10 dark:hover:bg-white/10 after:pointer-fine:hidden"
      >
