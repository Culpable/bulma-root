...
export type PricingSection = 'hero' | 'comparison' | 'faqs' | 'cta'

export default function Page({ section }: { section: PricingSection }) {
  return (
    <>
      {/* Hero */}
      {section === 'hero' && (
            ...
            <Plan
              ...
              features={[
                ...
                <span key="lenders">
                  ...
                  <a key="lender-count-link" href="/#lenders" className="underline underline-offset-2">
